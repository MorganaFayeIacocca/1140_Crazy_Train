...
# Form implementation generated from reading ui file 'CTCTest.ui'
#
...
from Train1Test import Ui_MainWindow1t
from Train2Test import Ui_MainWindow2t
from Train3Test import Ui_MainWindow3t
from Train4Test import Ui_MainWindow4t

class Ui_MainWindowt(object):
    def w1(self):
        self.window=QtWidgets.QMainWindow()
        self.ui=Ui_MainWindow1t()
        self.ui.setupUi(self.window)
        self.window.show()
    def w2(self):
        self.window=QtWidgets.QMainWindow()
        self.ui=Ui_MainWindow2t()
        self.ui.setupUi(self.window)
        self.window.show()
    def w3(self):
            self.window = QtWidgets.QMainWindow()
            self.ui = Ui_MainWindow3t()
            self.ui.setupUi(self.window)
            self.window.show()
    def w4(self):
            self.window = QtWidgets.QMainWindow()
            self.ui = Ui_MainWindow4t()
            self.ui.setupUi(self.window)
            self.window.show()
